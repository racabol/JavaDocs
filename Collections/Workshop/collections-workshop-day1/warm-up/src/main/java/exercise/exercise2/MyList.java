...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean equals(Object o) {
        ...
        if (differentElements != myList.differentElements) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + differentElements;
        return result;
    }
    ...
    public boolean addAll(Collection <? extends Integer> c) {
        for(Integer bucata: c){

            if(this.contains(bucata)==false){
                differentElements++;
            }
        }
    ...
    public Integer remove(int index) {
        ...
        Integer retinut= super.remove(index);
        if(this.contains(retinut)==false){
